...
const FooterCol = (props: { title: string, items: Array<{ title: string, address?: string }> }) => <div className="lg:ml-[70px]">
...
const Footer = () => {
  return <footer className="relative bottom-0 text-white lg:text-left text-center pt-[100px] xl:px-[170px] z-40">
